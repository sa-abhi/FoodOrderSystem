...
namespace Restaurant_OfferNews {
    ...
    public partial class RestaurantDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerInfoDataTable : global::System.Data.TypedTableBase<CustomerInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerInfoRow AddCustomerInfoRow(string Name, string Phone) {
...
namespace Restaurant_OfferNews.RestaurantDBDataSetTableAdapters {
    ...
    public partial class CustomerInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CustomerInfo] WHERE (([CustomerID] = @Original_CustomerID) AND" +
                " ([Name] = @Original_Name) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Pho" +
                "ne] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CustomerInfo] ([Name], [Phone]) VALUES (@Name, @Phone);\r\nSELEC" +
                "T CustomerID, Name, Phone FROM CustomerInfo WHERE (CustomerID = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CustomerInfo] SET [Name] = @Name, [Phone] = @Phone WHERE (([CustomerID] = @Original_CustomerID) AND ([Name] = @Original_Name) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT CustomerID, Name, Phone FROM CustomerInfo WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, Name, Phone FROM dbo.CustomerInfo";
        ...
        public virtual int Fill(RestaurantDBDataSet.CustomerInfoDataTable dataTable) {
        ...
        public virtual RestaurantDBDataSet.CustomerInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RestaurantDBDataSet.CustomerInfoDataTable dataTable = new RestaurantDBDataSet.CustomerInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RestaurantDBDataSet.CustomerInfoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_Name, string Original_Phone) {
        ...
        public virtual int Update(string Name, string Phone, int Original_CustomerID, string Original_Name, string Original_Phone, int CustomerID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, int Original_CustomerID, string Original_Name, string Original_Phone) {
            return this.Update(Name, Phone, Original_CustomerID, Original_Name, Original_Phone, Original_CustomerID);
        }
    }
